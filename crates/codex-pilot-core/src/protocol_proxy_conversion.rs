...
pub(crate) use crate::protocol_proxy_conversion_shared::{
    ...
    anthropic_usage_to_responses_usage, chat_delta_reasoning_text,
    chat_usage_to_responses_usage, default_responses_usage,
    leading_think_prefix_decision, parse_iso8601_timestamp,
